...
import (
  ...
  _ "github.com/gmlewis/go-fonts-o/fonts/oxygen_italic"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from oxygen_italic"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "oxygen_italic", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
