...
import (
  ...
  _ "github.com/gmlewis/go-fonts-o/fonts/overlockregular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from overlockregular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "overlockregular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
